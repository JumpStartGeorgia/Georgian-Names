...
set :application, "Mashasadame-Staging" # unique name of application
set :user, "mashasadame-staging" # name of user on server
...
set :github_repo_name, "Georgian-Names" # name of git hub repo
set :git_branch_name, "2016" # name of branch to deploy
