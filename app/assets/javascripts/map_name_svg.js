    ...
    d3.xml("/districts.svg", "image/svg+xml", function(xml) {
      ...
      $('svg#svg_map g path').each(function(){
        if ($(this).attr('district_id') == "0"){
          ...
          var found = false;
          for (var i=0; i < gon.map_name_json_svg.length; i++){
            var feature = gon.map_name_json_svg[i];
            ...
            if (feature.district_id.toString() == $(this).attr('district_id')){
              ...
              $(this).attr('rank', feature.rank);
              $(this).attr('rank_formatted', feature.rank_formatted);
              break;
            }
          }
